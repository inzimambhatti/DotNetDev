...
namespace UMISModuleAPI.Services
{
    public interface IUserService
    {
        ...
        AuthenticateResponse GoogleAuthenticate(AuthenticateRequest model);
    ...
    public class UserService : IUserService
    {
        ...
        public AuthenticateResponse Authenticate(AuthenticateRequest model)
        {
            ...
            cmd = "Select \"userID\" as userLoginId, \"userEmail\" as loginName, '' as Password,\"userMode\", \"userFullName\" as FullName from tbl_users where \"userEmail\" = '" + model.Loginname + "' and \"isDeleted\" = 0 and \"userPassword\" = '" + model.hashpassword + "'";
        ...
        public AuthenticateResponse GoogleAuthenticate(AuthenticateRequest model)
        {
            // cmd = "Select 'userID' as userLoginId, 'loginName' as loginName, '' as Password, 'roleId', 'empName' as FullName from view_user_login where 'loginName' = '" + model.Loginname + "' and 'Password' = '" + model.hashpassword + "';";
            cmd = "Select \"userID\" as userLoginId, \"userEmail\" as loginName, '' as Password,\"userMode\", \"userFullName\" as FullName from tbl_users where \"userEmail\" = '" + model.Loginname + "'";
            // cmd = "Select * from view_user_login";
